...
export function toggleDayModeAnimation(isDay: boolean): void {
...
export function toggleNightModeAnimation(isNight: boolean): void {
  const view = document.querySelector('.today-weather-view');
  if (!view) return;
...
export function updateNightMode(sunrise: string, sunset: string): void {
...
export function initializeDayNightToggle(onModeChange: () => void): void {
